...
<div class="like-button-container">
  <button id="increment-Nick" class="jaime-btn">
    ❤️ J'aime
          ...
          <img
            src="assets/desert/viperedesert.jpg"
...
<div class="like-button-container">
  <button id="increment-Abo" class="jaime-btn">
    ❤️ J'aime
         ...
         <article class="service">
          <img
            src="assets/desert/cobraroyal.jpg"
            onclick="agrandirImage(this)"
          />
        </article>
      </div>
      ...
      <div class="service4">
        <article class="service">
          <img
            src="assets/desert/dromadaire.jpg"
            onclick="agrandirImage(this)"
          />
        </article>
        <article class="description">
...
<div class="like-button-container">
  <button id="increment-Zed" class="jaime-btn">
    ❤️ J'aime
          ...
          <article class="service">
          <img
            src="assets/desert/iguanedesert.jpg"
            onclick="agrandirImage(this)"
          />
        </article>
      </div>
