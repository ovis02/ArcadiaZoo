...
<div class="like-button-container">
  <button id="increment-Tembo" class="jaime-btn">
    ❤️ J'aime
          ...
          <img
            src="assets/savane/elephant.jpg"
...
<div class="like-button-container">
  <button id="increment-Raja" class="jaime-btn">
    ❤️ J'aime
         ...
         <article class="service">
          <img
            src="assets/savane/guepard.jpg"
            onclick="agrandirImage(this)"
          />
        </article>
      </div>
      <hr class="service-divider">
      <div class="service4" id="lion">
        <article class="service">
          <img
...
<div class="like-button-container">
  <button id="increment-rhinoFamily" class="jaime-btn">
    ❤️ J'aime
          ...
          <article class="service">
          <img
            src="assets/savane/rhinoceros.jpg"
            onclick="agrandirImage(this)"
          />
        </article>
      </div>
